...
func main() {
	...
	//
	// At this stage you could argue that they are neither "on" nor "off", but
	// instead are in an in-between state, though it is likely that vSphere
	// would considered them to be in an "off" state, transitioning to an "on"
